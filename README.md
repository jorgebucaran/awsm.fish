...
- [codestats-fish](https://github.com/yunree/codestats-fish) - 🐟 A Fish shell plugin for [Code::Stats](https://codestats.net), the free stats tracking service for programmers.
